...
purge:
	...
	@echo
		...
		bash -c "(cd debian8; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.minimal.system:debian8_minimal;
		@echo
		@echo Purging containers, networks, volumes and images for debian7...
		bash -c "(cd debian7; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.minimal.system:debian7_minimal;
		@echo
		@echo Purging containers, networks, volumes and images for centos7...
		bash -c "(cd centos7; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.minimal.system:centos7_minimal;
		@echo
		@echo Purging containers, networks, volumes and images for centos6...
		bash -c "(cd centos6; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.minimal.system:centos6_minimal;
        else
		@echo Purging containers, networks, volumes and images for $(DISTRO)...
		bash -c "(cd $(DISTRO); set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.minimal.system:$(DISTRO)_minimal;
        endif
...
img-ls:
	...
	@echo
		...
		docker image ls | grep -E "stafli/stafli.minimal.system.*debian8" | sort -n;
		@echo
		@echo Listing images for debian7...
		docker image ls | grep -E "stafli/stafli.minimal.system.*debian7" | sort -n;
		@echo
		@echo Listing images for centos7...
		docker image ls | grep -E "stafli/stafli.minimal.system.*centos7" | sort -n;
		@echo
		@echo Listing images for centos6...
		docker image ls | grep -E "stafli/stafli.minimal.system.*centos6" | sort -n;
        else
		@echo Listing images for $(DISTRO)...
		docker image ls | grep -E "stafli/stafli.minimal.system.*$(DISTRO)" | sort -n;
        endif
...
con-inspect:
	...
	@echo
		...
		docker container inspect stafli_debian8_minimal_system_1;
		@echo
		@echo Inspecting containers for debian7...
		docker container inspect stafli_debian7_minimal_system_1;
		@echo
		@echo Inspecting containers for centos7...
		docker container inspect stafli_centos7_minimal_system_1;
		@echo
		@echo Inspecting containers for centos6...
		docker container inspect stafli_centos6_minimal_system_1;
        else
		@echo Inspecting containers for $(DISTRO)...
		docker container inspect stafli_$(DISTRO)_minimal_system_1;
        endif
...
con-ips:
	...
	@echo
		...
		docker container inspect stafli_debian8_minimal_system_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for debian7...
		docker container inspect stafli_debian7_minimal_system_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos7...
		docker container inspect stafli_centos7_minimal_system_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos6...
		docker container inspect stafli_centos6_minimal_system_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        else
		@echo Showing IP addresses of containers for $(DISTRO)...
		docker container inspect stafli_$(DISTRO)_minimal_system_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        endif
...
con-ports:
	...
	@echo
		...
		docker container port stafli_debian8_minimal_system_1;
		@echo
		@echo Showing ports of containers for debian7...
		docker container port stafli_debian7_minimal_system_1;
		@echo
		@echo Showing ports of containers for centos7...
		docker container port stafli_centos7_minimal_system_1;
		@echo
		@echo Showing ports of containers for centos6...
		docker container port stafli_centos6_minimal_system_1;
        else
		@echo Showing ports of containers for $(DISTRO)...
		docker container port stafli_$(DISTRO)_minimal_system_1;
        endif
...
con-top:
	...
	@echo
		...
		docker container top stafli_debian8_minimal_system_1;
		@echo
		@echo Showing processes of containers for debian7...
		docker container top stafli_debian7_minimal_system_1;
		@echo
		@echo Showing processes of containers for centos7...
		docker container top stafli_centos7_minimal_system_1;
		@echo
		@echo Showing processes of containers for centos6...
		docker container top stafli_centos6_minimal_system_1;
        else
		@echo Showing processes of containers for $(DISTRO)...
		docker container top stafli_$(DISTRO)_minimal_system_1;
        endif
