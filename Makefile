#
#    Stafli Minimal System (Makefile)
...
purge:
	...
	@echo
		...
		bash -c "(cd debian8; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.system.minimal:minimal10_debian8;
		@echo
		@echo Purging containers, networks, volumes and images for debian7...
		bash -c "(cd debian7; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.system.minimal:minimal10_debian7;
		@echo
		@echo Purging containers, networks, volumes and images for centos7...
		bash -c "(cd centos7; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.system.minimal:minimal10_centos7;
		@echo
		@echo Purging containers, networks, volumes and images for centos6...
		bash -c "(cd centos6; set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.system.minimal:minimal10_centos6;
        else
		@echo Purging containers, networks, volumes and images for $(DISTRO)...
		bash -c "(cd $(DISTRO); set -o allexport; source .env; set +o allexport; docker-compose down)";
		docker image rm stafli/stafli.system.minimal:minimal10_$(DISTRO);
        endif
...
img-ls:
	...
	@echo
		...
		docker image ls | grep -E "stafli/stafli.system.minimal.*debian8" | sort -n;
		@echo
		@echo Listing images for debian7...
		docker image ls | grep -E "stafli/stafli.system.minimal.*debian7" | sort -n;
		@echo
		@echo Listing images for centos7...
		docker image ls | grep -E "stafli/stafli.system.minimal.*centos7" | sort -n;
		@echo
		@echo Listing images for centos6...
		docker image ls | grep -E "stafli/stafli.system.minimal.*centos6" | sort -n;
        else
		@echo Listing images for $(DISTRO)...
		docker image ls | grep -E "stafli/stafli.system.minimal.*$(DISTRO)" | sort -n;
        endif
...
con-inspect:
	...
	@echo
		...
		docker container inspect stafli_system_minimal10_debian8_1;
		@echo
		@echo Inspecting containers for debian7...
		docker container inspect stafli_system_minimal10_debian7_1;
		@echo
		@echo Inspecting containers for centos7...
		docker container inspect stafli_system_minimal10_centos7_1;
		@echo
		@echo Inspecting containers for centos6...
		docker container inspect stafli_system_minimal10_centos6_1;
        else
		@echo Inspecting containers for $(DISTRO)...
		docker container inspect stafli_system_minimal10_$(DISTRO)_1;
        endif
...
con-ips:
	...
	@echo
		...
		docker container inspect stafli_system_minimal10_debian8_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for debian7...
		docker container inspect stafli_system_minimal10_debian7_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos7...
		docker container inspect stafli_system_minimal10_centos7_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos6...
		docker container inspect stafli_system_minimal10_centos6_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        else
		@echo Showing IP addresses of containers for $(DISTRO)...
		docker container inspect stafli_system_minimal10_$(DISTRO)_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        endif
...
con-ports:
	...
	@echo
		...
		docker container port stafli_system_minimal10_debian8_1;
		@echo
		@echo Showing ports of containers for debian7...
		docker container port stafli_system_minimal10_debian7_1;
		@echo
		@echo Showing ports of containers for centos7...
		docker container port stafli_system_minimal10_centos7_1;
		@echo
		@echo Showing ports of containers for centos6...
		docker container port stafli_system_minimal10_centos6_1;
        else
		@echo Showing ports of containers for $(DISTRO)...
		docker container port stafli_system_minimal10_$(DISTRO)_1;
        endif
...
con-top:
	...
	@echo
		...
		docker container top stafli_system_minimal10_debian8_1;
		@echo
		@echo Showing processes of containers for debian7...
		docker container top stafli_system_minimal10_debian7_1;
		@echo
		@echo Showing processes of containers for centos7...
		docker container top stafli_system_minimal10_centos7_1;
		@echo
		@echo Showing processes of containers for centos6...
		docker container top stafli_system_minimal10_centos6_1;
        else
		@echo Showing processes of containers for $(DISTRO)...
		docker container top stafli_system_minimal10_$(DISTRO)_1;
        endif
