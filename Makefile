...
con-inspect:
	...
	@echo
		...
		docker container inspect debian8_minimal_1;
		@echo
		@echo Inspecting containers for debian7...
		docker container inspect debian7_minimal_1;
		@echo
		@echo Inspecting containers for centos7...
		docker container inspect centos7_minimal_1;
		@echo
		@echo Inspecting containers for centos6...
		docker container inspect centos6_minimal_1;
        else
		@echo Inspecting containers for $(DISTRO)...
		docker container inspect $(DISTRO)_minimal_1;
        endif
...
con-ips:
	...
	@echo
		...
		docker container inspect debian8_minimal_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for debian7...
		docker container inspect debian7_minimal_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos7...
		docker container inspect centos7_minimal_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos6...
		docker container inspect centos6_minimal_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        else
		@echo Showing IP addresses of containers for $(DISTRO)...
		docker container inspect $(DISTRO)_minimal_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        endif
...
con-ports:
	...
	@echo
		...
		docker container port debian8_minimal_1;
		@echo
		@echo Showing ports of containers for debian7...
		docker container port debian7_minimal_1;
		@echo
		@echo Showing ports of containers for centos7...
		docker container port centos7_minimal_1;
		@echo
		@echo Showing ports of containers for centos6...
		docker container port centos6_minimal_1;
        else
		@echo Showing ports of containers for $(DISTRO)...
		docker container port $(DISTRO)_minimal_1;
        endif
