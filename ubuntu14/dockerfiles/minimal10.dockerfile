...
#
#    Ubuntu 14.04 (trusty) Minimal10 System (dockerfile)
...
#  - apt-utils: for apt-extracttemplates, used by debconf to provide defaults for prompts (668 kB, optional)
#  - apt-transport-https: to allow HTTPS connections to sources in apt (1448 kB + 10 mB, optional) (shares dependencies with curl)
# Install the selected packages
#   Install the base packages
#    - bash: for bash, the GNU Bash shell (5010 kB, essential)
#    - tzdata: to provide time zone and daylight-saving time data (1537 kB, essential)
#    - locales: to provide common files for locale support (9012 kB, optional)
#   Install the administration packages
#    - debianutils: for which and others, basic administration packages (283 kB, essential)
#    - procps: for kill, top and others, basic administration packages (680 kB, optional)
#   Install the programming packages
#    - sed: for sed, the GNU stream editor (304 kB, essential)
#    - perl-base: for perl, an interpreter for the Perl Programming Language (4858 kB, essential)
#    - python-minimal: for python, an interpreter for the Python Programming Language (167 kB + 3393 kB + 2497 kB, optional)
#   Install the find and replace packages
#    - grep: for grep/egrep/fgrep, the GNU utilities to search text in files (712 kB, essential)
#    - findutils: for find, the file search utility (816 kB, essential)
#    - tree: for tree, displays directory tree, in color (106 kB, optional)
#   Install the archive and compression packages
#    - tar: for tar, the GNU tar archiving utility (768 kB, essential)
#    - gzip: for gzip, the GNU compression utility which uses DEFLATE algorithm (236 kB, essential)
#   Install the network diagnosis packages
#    - inetutils-ping: for ping/6, the portable GNU implementation of ping (347 kB + 66 kB, optional)
...
#    - curl: for curl, a network utility to transfer data via FTP, HTTP, SCP, and other protocols (309 kB + ... 10 mB, optional) (shares dependencies with apt-transport-https)
#   Install the crypto packages
#    - gnupg: for gnupg, the GNU privacy guard cryptographic utility (1680 kB, essential)
#    - gnupg-curl: to add support for secure HKPS keyservers (131 kB, optional) (shares dependencies with gnupg and curl)
#    - gpgv: for gpgv, the GNU privacy guard signature verification tool (443 kB, essential) (shares dependencies with gnupg)
#    - openssl: for openssl, the OpenSSL cryptographic utility required for many packages (907 kB, optional)
#    - ca-certificates: adds trusted PEM files of CA certificates to the system (405 kB, optional)
#   Install the misc packages
#    - nano: for nano, a tiny editor based on pico (600 kB + 374 kB, optional)
#    - vim-tiny: for vim editor, an almost compatible version of the UNIX editor Vi (931 kB + 317 kB, optional)
